...
async def test_all_tools():
    ...
    async with stdio_client(server_params) as (read, write):
        async with ClientSession(read, write) as session:
            ...
            result = await session.call_tool("list_available_versions", {
                "include_stats": True
            })
            ...
            result = await session.call_tool("get_document_outline", {
            ...
            result = await session.call_tool("batch_search", {
                "version_id": version_id,
            ...
            result = await session.call_tool("compare_across_versions", {
                "version_ids": [
            ...
            result = await session.call_tool("extract_key_value", {
                "version_id": version_id,
